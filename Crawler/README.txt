...
#############################################################################################################
 ...
 STEPS TO RUN PROGRAM:
		...
		> Navigate to the desired directory where the files FocusedWebCrawler.py, WebCrawler.py are placed.
...
RESULTS:
		...
		> After running the command 'python WebCrawler.py' 
		  This will lead to creation of two directories and two text files in the same directory:
		     1. BFS-FILES : this contains text files containing HTML content for each crawled URL using BFS.
		...
		> After running the command 'python WebCrawler.py'
		   This will lead to creation of one directory and a text file in the same directory.
		     1. ListOfUrlsFocusedCrawl.txt : this contains list of 1000 URLS crawled by BFS focused crawler.
